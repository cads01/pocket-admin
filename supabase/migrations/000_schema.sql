-- Pocket Admin v2 Schema — Marketplace Platform

-- Drop existing (order matters for FK)
...
-- 5. BOOKING_TASKS (room-by-room checklist)
...
-- 10. DISPUTES (scope creep / service recovery)
...
-- 12. CLEANER_VIDEOS (YouTube/Stories)
